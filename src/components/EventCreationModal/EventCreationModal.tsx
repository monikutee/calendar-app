...
export const EventCreationModal: React.FC = () => {
  const { setModalVisibility, displayDate, setDisplayDate, events, setEvents } =
  ...
  const [selectedEndTime, setSelectedEndTime] = React.useState(initialEndTime);
  ...
  React.useEffect(() => {
    ...
    setSelectedEndTime(selectedStartTime === "23:00" ? "23:59" : `${hrs}:00`);
  }, [selectedStartTime]);
